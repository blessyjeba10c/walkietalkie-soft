...
struct DisplayState {
    ...
    String messageQueue[10]; // Circular queue for incoming messages
    int messageQueueHead = 0; // Where to insert new messages
    int messageQueueTail = 0; // Where to read messages from (oldest)
