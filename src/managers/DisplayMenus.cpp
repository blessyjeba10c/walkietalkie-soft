...
void createLoRaMenu() {
    displayState.currentMenu.title = "LoRa";
    displayState.currentMenu.selectedItem = 0;
    displayState.currentMenu.itemCount = 5;
    
    displayState.currentMenu.items[0] = {"Send Message", "input_lorasms", false};
    displayState.currentMenu.items[1] = {"LoRa Status", "lorastatus", false};
    displayState.currentMenu.items[2] = {"ACK Mode ON", "ackon", false};
    displayState.currentMenu.items[3] = {"ACK Mode OFF", "ackoff", false};
